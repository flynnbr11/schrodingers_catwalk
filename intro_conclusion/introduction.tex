...
These \emph{quantum technologies} share the promise of super-classical outcomes,
...
\begin{description}
    ...
    \item[\cref{part:algorithms} Algorithms] \
        ...
        Our next contribution is an open source software platform for the implementation of \gls{qmla}, 
            for the study of arbitrary quantum systems.
    ...
    \item[\cref{part:experimental_study} Experimental Study] \
        ...
        \cref{chapter:nv} relied on several constraints to facilitate the \gls{model search}; 
            in \cref{chapter:many_qubits} we relax some of those constraints by simulating a similar system, 
            and again exploit a \acrlong{ga} to explore the \gls{model space}. 
