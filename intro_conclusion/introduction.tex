...
In parallel to the rise of quantum technologies over the past several decades,
    \gls{ml} and \glsentrylong{ai} have enjoyed increasing interest and resources.
Landmark outcomes, for example in facial recognition \cite{taigman2014deepface} 
    ...
    such as supercomputing facilities \cite{top500} and \glsentrylongpl{gpu} \cite{lindholm2008nvidia}.
...
In providing a robust software framework for \gls{qmla}, we initiate an exciting field of research 
    at the overlap of \glsentrylong{ml} and quantum simulation, 
...
\begin{description}
    \item[\cref{part:contextual_review} Contextual Review] \
        ...
        \cref{chapter:qm} establishes the vocabulary of \glsentrylong{qm}, 
            followed by a summary of \glsentrylong{ml} in \cref{chapter:ml}. 
    ...
    \item[\cref{part:algorithms} Algorithms] \
        ...
        We start by summarising \glsentrylong{qhl}, which serves as a key subroutine within later studies and should therefore 
    ...
    \item[\cref{part:theoretical_study} Theoretical Study] \
        ...
        We then move to more difficult conditions in \cref{chapter:ga}, 
            exploring spaces of $10^5$ valid candidate models, by incorporating a \glsentrylong{ga} within \gls{qmla}. 
    ...
    \item[\cref{part:experimental_study} Experimental Study] \
        ...
        dynamics of an electron spin in a \glsentrylong{nvc}. 
        ...
        \cref{chapter:nv} relied on several constraints to facilitate the model search; 
            ...
            and again exploiting a \glsentrylong{ga} to explore the model space. 
