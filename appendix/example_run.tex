...
\footnotetext{
    ...
    This can be reduced by lowering the values of \ttt{particles}, \ttt{experiments}, 
...
We must therefore \emph{estimate} the time it will take for an \gls{instance} to complete:
    clearly this is strongly dependent on the numbers of experiments (\gls{nexp}) and particles (\gls{nprt}), 
