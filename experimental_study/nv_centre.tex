...
As discussed in \cref{sec:heuristic}, usually it is helpful to allow a \glsentryfull{edh} to
...
\begin{figure}
    ...
    \end{center}
    \caption[
        Models considered by \gls{qmla} for simulated/experimental \glsentrylong{nvc} data, and their  \gls{win rate} s
    ]{
    ...
    reported as a histogram for cases adopting simulated data (empty bars) or the experimental dataset (green bars).
    \figtableref
    } 
