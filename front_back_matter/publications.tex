...
\subsection*{Software}
\begin{easylist}
    & \emph{\glsentryshort{qmla}: Python framework for the reverse engineering of Hamiltonian models of quantum systems through machine learning.} 
