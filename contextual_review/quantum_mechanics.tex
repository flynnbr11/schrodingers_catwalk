...
The cornerstone of \gls{qm} is the effect of \emph{measurement} on quantum systems: 
    ...
    observing the system forces $\ket{\psi}$ into definite occupation of a single eigenstate,
...
\end{equation}
    ...
    $\ket{v_i}$ are the eigenstates of $\hat{A}$, and $\alpha_i \in \mathbb{C}$ are the proability amplitudes
