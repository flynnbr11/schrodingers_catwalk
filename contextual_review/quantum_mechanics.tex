...
Advances in theoretical understanding of quantum mechanical systems in the first half of the century 
    ...
    % TODO get references  - google scholar broken temporarily
    % On a heuristic point of view concerning the production and transformation of light - Einstein
    %  "An Undulatory Theory of the Mechanics of Atoms and Molecules" -  schrodinger
    ...
    % Principles of lasers, 2010 Svelto
    % Principles of semiconductor devices - Zeghbroeck 2004
