...
\begin{description}
    ...
    The method through which to design bespoke experiments to maximise the information 
...
\begin{algorithm}
    ...
    \KwIn{\gls{nexp} \tcp*[1]{number of experiments to iterate learning procedure for}}
