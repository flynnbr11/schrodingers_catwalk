...
\begin{figure}
    ...
    \centering
    \subfloat[]{
        \includegraphics[scale=1]{algorithms/figures/smc_demo/epoch_0.pdf}
    }
    \subfloat[]{
        \includegraphics[scale=1]{algorithms/figures/smc_demo/epoch_9.pdf}
    }
    \subfloat[]{
        \includegraphics[scale=1]{algorithms/figures/smc_demo/epoch_10.pdf}
    }
    % \hspace{0mm}
    
    \subfloat[]{
        \includegraphics[scale=1]{algorithms/figures/smc_demo/epoch_50.pdf}
    }
    \subfloat[]{ 
    \includegraphics[scale=1]{algorithms/figures/smc_demo/epoch_100.pdf}
    }
    \subfloat[]{ 
    \includegraphics[scale=1]{algorithms/figures/smc_demo/epoch_500.pdf}
    }
    \hspace{0mm}
    \subfloat{
...
The \glsentrylong{le} -- or the \emph{fidelity} -- is given by 
\begin{equation}
...
Then, it is sensible to use $t \approx t_{max}$ as the bespoke design with respect to a given prior, 
