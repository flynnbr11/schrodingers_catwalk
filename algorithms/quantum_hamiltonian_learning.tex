...
$M(t)$ is dictated by the \emph{similarity} between the two Hamiltonians.
...
This is the basis of the \glsentrylong{pgh}, described in \cref{sec:pgh}. 
\par 
...
\footnotetext{
    ...
    rooted in the effect of the \glsentrylong{le}, described in \cref{sec:iqle}.
}
...
\footnotetext{
    ...
    but merely to serve as examples of simulatable Hamiltonians. 
}
...
\begin{figure}
    ...
    \end{center}
    \caption[Effect on model training of \glsentrylong{edh}]{
