...
\begin{lstlisting}[
    ...
    caption={
        Child class, encoding the concept of a footballer, which adopts the abstrat representation of an athlete. 
...
\begin{figure}
    ...
    \caption[Parallel architecture for \gls{qmla}]{
        Parallel architecture for \glsentryfull{qmla}.
...
The user has control on which plots are generated, in order that the appropriate degree of analysis is produced, 
