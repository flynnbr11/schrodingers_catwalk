...
\begin{figure}
    ...
    \caption[Genetic algorithm parameter sweep]{
        ...
        Each subplot shows the success rates 
    }
...
After choosing some random target $\ho$, 
    we run a single generation using each \gls{of}, and judge them 
    by the quality of models they produce 
