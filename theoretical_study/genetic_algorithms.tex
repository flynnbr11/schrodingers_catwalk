...
When a pair of parents have been nominated by the selection mechanism above, 
    it remains to use those parents to spawn offsprint, 
    which should inherit the properties of their parents. 
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{cccc}
            Parent 1 & Parent 2 & $\kappa$ & Selection probability \\
            \hline 
    ...
    \caption[Genetic algorithm parent selection database]{
        ...
        Pairs of parents are selected together, with the selection probability (unnormalised) 
