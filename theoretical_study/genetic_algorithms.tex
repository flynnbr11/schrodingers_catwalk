...
\par 
We extend the analysis of \cref{fig:single_models_elo_ratings} to all $N_m$ models 
...
\begin{figure}
    \begin{center}
        \includegraphics{theoretical_study/figures/gen_alg_instance.pdf}
    \end{center}
    \caption[\Gls{instance} of \gls{qmla} \gls{ga}.]{
        Gene pool for an \gls{instance} of \gls{qmla} \gls{ga}. 
        Each tile in each generation represents a model by its $\fs$. 
    }
