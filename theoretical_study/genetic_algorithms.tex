...
\begin{figure}
    ...
    \caption[Single model within a single generation of QMLA genetic algorithm]{
        ...
        The $x$-axis marks successive comparisons for $\hi$ against 12 of the 60 contemporary models in the same generation;
        the models against which $\hi$ compete are set by the edges of a random regular graph with models as vertices. 
