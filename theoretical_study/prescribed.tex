...
\footnotetext{
    Recall the main resources for model training: the number of experiments performed, $\Ne$, and the number of particles used during \gls{qhl}, $\Np$.
}
\par
...
If \gls{qmla} does not give clear results, then, we may expect a clearer outcome from increasing $\Ne, \Np$.
