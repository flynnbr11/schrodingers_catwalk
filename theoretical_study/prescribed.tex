...
\footnotetext{
    Recall the main resources for model training: the number of experiments performed, \gls{nexp}, and the number of \glspl{particle} used during \gls{qhl}, \gls{nprt}.
}
\par
