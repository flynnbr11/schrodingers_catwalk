...
\begin{figure}
    \QMLAfig{Nov_16/23_51/two_param_ising_qhl.pdf}
...
\begin{figure}
    \QMLAfig{Nov_16/20_05/fully_parameterised_ising_qhl.pdf}
    \caption[\gls{qhl} for Ising model]{
...
We can then devise a simple \gls{es} which only tests the models corresponding to $\mathbb{C}$, 
    ...
    \crefrange{alg:lattice_exploration_strategy,alg:lattice_exploration_strategy_consolidation}.
